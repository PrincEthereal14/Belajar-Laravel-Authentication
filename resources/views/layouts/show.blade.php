            ...
            <div class="card-body">
              ...
              <form class="forms-sample">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="col-sm-3 col-form-label"  value="{{$variabelblade->id}}" disabled> 
                  </div>
                </div>
                <div class="form-group row">
                  <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Nama Makanan</label>
                  <div class="col-sm-9">
                    <input type="text" class="col-sm-3 col-form-label"  disabled value="{{$variabelblade->nama}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="exampleInputMobile" class="col-sm-3 col-form-label">Deskripsi</label>
                  <div class="col-sm-9">
                    <input type="text" class="col-sm-3 col-form-label"  disabled value="{{$variabelblade->deskripsi}}">
                  </div>
                </div>
                <div class="form-group row">
                    <label for="exampleInputMobile" class="col-sm-3 col-form-label">Kategori</label>
                    <div class="col-sm-9">
                      <input type="text" class="col-sm-3 col-form-label"  disabled value="{{$variabelblade->kategori}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="exampleInputMobile" class="col-sm-3 col-form-label">Harga</label>
                    <div class="col-sm-9">
                      <input type="text" class="col-sm-3 col-form-label"  disabled value="{{$variabelblade->harga}}">
                    </div>
                  </div>
                {{-- <div class="form-group row">
                ...
                {{-- <button type="submit" class="btn btn-primary mr-2">Kembali</button> --}}
